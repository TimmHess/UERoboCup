...
unrealRootPath=/home/shared/Hess/UnrealEngine4/UnrealEngine-4.14.3-release
TrainingSetGeneratorRootPath=/home/shared/Hess/UE_Projects/TrainingSetGenerator 4.14

gameProjectFile=/home/shared/Hess/UE_Projects/TrainingSetGenerator 4.14/TrainingSetGenerator.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(TrainingSetGeneratorSource.pri)
include(TrainingSetGeneratorHeader.pri)
include(TrainingSetGeneratorConfig.pri)
include(TrainingSetGeneratorIncludes.pri)
include(TrainingSetGeneratorDefines.pri)
...
TrainingSetGenerator-Linux-Debug.commands = $$build TrainingSetGenerator Linux Debug  -project="\"$$gameProjectFile\"" $$args
TrainingSetGenerator-Linux-DebugGame.commands = $$build TrainingSetGenerator Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TrainingSetGenerator-Linux-Shipping.commands = $$build TrainingSetGenerator Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TrainingSetGenerator-Linux-Test.commands = $$build TrainingSetGenerator Linux Test  -project="\"$$gameProjectFile\"" $$args
TrainingSetGenerator.commands = $$build TrainingSetGenerator Linux Development  -project="\"$$gameProjectFile\"" $$args

TrainingSetGeneratorEditor-Linux-Debug.commands = $$build TrainingSetGeneratorEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
TrainingSetGeneratorEditor-Linux-DebugGame.commands = $$build TrainingSetGeneratorEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TrainingSetGeneratorEditor-Linux-Shipping.commands = $$build TrainingSetGeneratorEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TrainingSetGeneratorEditor-Linux-Test.commands = $$build TrainingSetGeneratorEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
TrainingSetGeneratorEditor.commands = $$build TrainingSetGeneratorEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	TrainingSetGenerator-Linux-Debug \
	TrainingSetGenerator-Linux-DebugGame \
	TrainingSetGenerator-Linux-Shipping \
	TrainingSetGenerator-Linux-Test \
	TrainingSetGenerator \
	TrainingSetGeneratorEditor-Linux-Debug \
	TrainingSetGeneratorEditor-Linux-DebugGame \
	TrainingSetGeneratorEditor-Linux-Shipping \
	TrainingSetGeneratorEditor-Linux-Test \
	TrainingSetGeneratorEditor \
